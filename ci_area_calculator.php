...
Version: 1.0.0
Author: Area Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Area Calculator by www.calculator.io";

function display_calcio_ci_area_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_area_calculator', 'display_calcio_ci_area_calculator' );